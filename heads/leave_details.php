...
if(isset($_POST['tackAction']))
{
    ...
    if ($result) {
        if($isReadUpdate >= 3 and $roleData['role'] == 'DVC' and $status == 1){
            ...
            $sql = "UPDATE `tblemployees` SET `Av_leave` = '{$signedLeaveDay}' WHERE `tblemployees`.`emp_id` = '{$emp_id}'";
            $result = mysqli_query($conn,$sql);
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body text-center font-18">
                                                        ...
                                                        <input type="hidden" name="emp_id" value="<?= $result->emp_id; ?>" readonly>
                                                        <input type="hidden" name="Av_leave" value="<?= $result->Av_leave; ?>" readonly>
                                                        <div class="form-group">
                                                            <label></label>
